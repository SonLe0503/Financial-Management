...
interface SellCertificateProps {
  open: boolean;
  setOpen: (open: boolean) => void;
}

const SellCertificate = (props: SellCertificateProps) => {
        ...
        >
          ...
          <div className="d_fc w_100 ">
            ...
            <div className="d_f m_t20">
              <Button className="w_100" variant="contained" color="warning">Bán</Button>
            </div>
          </div>
        </Box>
      </Modal>
...
export default SellCertificate;